...
```bash
dxpcli p2p ping <enode/enr or nodes.json file>
```
...
- [dxpcli p2p crawl](dxpcli_p2p_crawl.md) - Crawl a network on the devp2p layer and generate a nodes JSON file.

- [dxpcli p2p nodelist](dxpcli_p2p_nodelist.md) - Generate a node list to seed a node

- [dxpcli p2p ping](dxpcli_p2p_ping.md) - Ping node(s) and return the output.

- [dxpcli p2p query](dxpcli_p2p_query.md) - Query block header(s) from node and prints the output.

- [dxpcli p2p sensor](dxpcli_p2p_sensor.md) - Start a devp2p sensor that discovers other peers and will receive blocks and transactions.
