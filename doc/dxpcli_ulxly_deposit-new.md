...
```bash
dxpcli ulxly deposit-new [flags]
```
...
Upon successful deposit, the transaction can be queried using `dxpcli ulxly deposit-get` command
...
- [dxpcli ulxly](dxpcli_ulxly.md) - Utilities for interacting with the lxly bridge
