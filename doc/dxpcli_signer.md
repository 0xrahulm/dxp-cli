...
- [dxpcli signer create](dxpcli_signer_create.md) - Create a new key

- [dxpcli signer import](dxpcli_signer_import.md) - Import a private key into the keyring / keystore

- [dxpcli signer list](dxpcli_signer_list.md) - List the keys in the keyring / keystore

- [dxpcli signer sign](dxpcli_signer_sign.md) - Sign tx data
